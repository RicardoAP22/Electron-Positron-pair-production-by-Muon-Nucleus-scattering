...
{
  auto ptr = new G4MuPairProduction();
  ptr->AddEmModel(-1, new G4RiGeMuPairProductionModel, nullptr);
  ...
  pmanager->AddProcess(ptr, -1, 4, 4);
  pmanager->AddProcess(new G4MuonToMuonPairProduction(), -1, 5, 5);
  pmanager->AddProcess(new G4MuMultipleScattering(), -1, 6, 6);
